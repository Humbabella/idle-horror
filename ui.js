...
it.section = function (args, tab) {
	...
	section.node.body = H.e('div', section.node, 'section_body');
	section.node.collapse_button = H.e('div', section.node.heading, 'section_collapse_button', '-')
	
	section.node.collapse_button.addEventListener('click', section.collapse)
